...
sealed class CheckBox : ControlElements
{
    ...
    public CheckBox(string name, bool isChecked) : base(name, new ScreenPosition(0, 0), ControlType.CheckBox)
    {
        IsChecked = isChecked;
    }
...
class RadioButton : ControlElements
{
    ...
    public RadioButton(string name, bool isSelected) : base(name, new ScreenPosition(0, 0), ControlType.RadioButton)
    {
...
{
    public Button(string name) : base(name, new ScreenPosition(0, 0), ControlType.Button) { }
